...
type UserManagementClient interface {
	...
	DeleteUser(ctx context.Context, in *DeleteUserParams, opts ...grpc.CallOption) (*DeletedUser, error)
}
...
func (c *userManagementClient) CreateNewUser(ctx context.Context, in *NewUser, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/users.UserManagement/CreateNewUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagementClient) GetUsers(ctx context.Context, in *GetUsersParams, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
	err := c.cc.Invoke(ctx, "/users.UserManagement/GetUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagementClient) DeleteUser(ctx context.Context, in *DeleteUserParams, opts ...grpc.CallOption) (*DeletedUser, error) {
	out := new(DeletedUser)
...
type UserManagementServer interface {
	...
	DeleteUser(context.Context, *DeleteUserParams) (*DeletedUser, error)
...
func (UnimplementedUserManagementServer) DeleteUser(context.Context, *DeleteUserParams) (*DeletedUser, error) {
...
func _UserManagement_CreateNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.UserManagement/CreateNewUser",
	}
...
func _UserManagement_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.UserManagement/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserManagement_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).DeleteUser(ctx, req.(*DeleteUserParams))
	}
	return interceptor(ctx, in, info, handler)
}
